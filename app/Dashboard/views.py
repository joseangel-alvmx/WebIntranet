...
from .models import Tareas, VacanteActivas,Cursos,InventarioSoporte,Ubicaciones,Noticias, UsuariosGA,Procesos, Empresas,TipoDocumento,Departamentos
...
def empresa(request):
    ...
    anuncios = Noticias.objects.filter(tipo_noticia=4, empresa=1).select_related('user','tipo_noticia').order_by('-fecha_ingreso')[:2]
    nacs = UsuariosGA.objects.annotate(mes_nacimiento=ExtractMonth('fecha_nacimiento'),dia_nacimiento=ExtractDay('fecha_nacimiento')).filter(empresa=1,mes_nacimiento=hoy.month,dia_nacimiento__gte=hoy.day,dia_nacimiento__lte=fecha_limite.day).order_by('fecha_nacimiento')
    ...
    anivs = UsuariosGA.objects.annotate(mes_nacimiento=ExtractMonth('fecha_ingreso'),dia_nacimiento=ExtractDay('fecha_ingreso')).filter(empresa=1,mes_nacimiento=hoy.month,dia_nacimiento__gte=hoy.day,dia_nacimiento__lte=fecha_limite.day).order_by('fecha_ingreso')
    if fecha_limite.month != hoy.month:
...
def dintranet(request):
    ...
    anuncios = Noticias.objects.filter(tipo_noticia=4, empresa=2).select_related('user','tipo_noticia').order_by('-fecha_ingreso')[:2]
    nacs = UsuariosGA.objects.annotate(mes_nacimiento=ExtractMonth('fecha_nacimiento'),dia_nacimiento=ExtractDay('fecha_nacimiento')).filter(empresa=2,mes_nacimiento=hoy.month,dia_nacimiento__gte=hoy.day,dia_nacimiento__lte=fecha_limite.day).order_by('fecha_nacimiento')
    if fecha_limite.month != hoy.month:
        acs = UsuariosGA.objects.annotate(
            mes_nacimiento=ExtractMonth('fecha_nacimiento'),
            dia_nacimiento=ExtractDay('fecha_nacimiento') 
    ...
    anivs = UsuariosGA.objects.annotate(mes_nacimiento=ExtractMonth('fecha_ingreso'),dia_nacimiento=ExtractDay('fecha_ingreso')).filter(empresa=2,mes_nacimiento=hoy.month,dia_nacimiento__gte=hoy.day,dia_nacimiento__lte=fecha_limite.day).order_by('fecha_ingreso')
    if fecha_limite.month != hoy.month:
        anv = UsuariosGA.objects.annotate(
            mes_nacimiento=ExtractMonth('fecha_ingreso'),
            dia_nacimiento=ExtractDay('fecha_ingreso') 
...
def tradepolymers(request):
    ...
    anuncios = Noticias.objects.filter(tipo_noticia=4, empresa=4).select_related('user','tipo_noticia').order_by('-fecha_ingreso')[:2]
    nacs = UsuariosGA.objects.annotate(mes_nacimiento=ExtractMonth('fecha_nacimiento'),dia_nacimiento=ExtractDay('fecha_nacimiento')).filter(empresa=4,mes_nacimiento=hoy.month,dia_nacimiento__gte=hoy.day,dia_nacimiento__lte=fecha_limite.day).order_by('fecha_nacimiento')
    if fecha_limite.month != hoy.month:
        acs = UsuariosGA.objects.annotate(
            mes_nacimiento=ExtractMonth('fecha_nacimiento'),
            dia_nacimiento=ExtractDay('fecha_nacimiento') 
    ...
    anivs = UsuariosGA.objects.annotate(mes_nacimiento=ExtractMonth('fecha_ingreso'),dia_nacimiento=ExtractDay('fecha_ingreso')).filter(empresa=4,mes_nacimiento=hoy.month,dia_nacimiento__gte=hoy.day,dia_nacimiento__lte=fecha_limite.day).order_by('fecha_ingreso')
    if fecha_limite.month != hoy.month:
        anv = UsuariosGA.objects.annotate(
            mes_nacimiento=ExtractMonth('fecha_ingreso'),
            dia_nacimiento=ExtractDay('fecha_ingreso') 
...
def alvaenvases(request):
    ...
    anuncios = Noticias.objects.filter(tipo_noticia=4, empresa=3).select_related('user','tipo_noticia').order_by('-fecha_ingreso')[:2]
    nacs = UsuariosGA.objects.annotate(mes_nacimiento=ExtractMonth('fecha_nacimiento'),dia_nacimiento=ExtractDay('fecha_nacimiento')).filter(empresa=3,mes_nacimiento=hoy.month,dia_nacimiento__gte=hoy.day,dia_nacimiento__lte=fecha_limite.day).order_by('fecha_nacimiento')
    if fecha_limite.month != hoy.month:
        acs = UsuariosGA.objects.annotate(
            mes_nacimiento=ExtractMonth('fecha_nacimiento'),
            dia_nacimiento=ExtractDay('fecha_nacimiento') 
    ...
    anivs = UsuariosGA.objects.annotate(mes_nacimiento=ExtractMonth('fecha_ingreso'),dia_nacimiento=ExtractDay('fecha_ingreso')).filter(empresa=3,mes_nacimiento=hoy.month,dia_nacimiento__gte=hoy.day,dia_nacimiento__lte=fecha_limite.day).order_by('fecha_ingreso')
    if fecha_limite.month != hoy.month:
        anv = UsuariosGA.objects.annotate(
            mes_nacimiento=ExtractMonth('fecha_ingreso'),
            dia_nacimiento=ExtractDay('fecha_ingreso') 
